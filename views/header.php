<?php
//en caso de que la session este vacia y no tenga valor se reinicara y se obtendra un valor de session
    ...
    <body class="hold-transition skin-blue-light sidebar-mini">
        ...
        <aside class="main-sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <!-- VERIFICAR SI EL USUARIO TIENE PERMISOS PARA ACCEDER A ALGUNOS ROLES EN CASO
                    CONTRARIO SE LE OCULTARA LOS BOTONES DE MENU DE LOS ROLES-->
                <?php
